...
class ImageLoader(){
    fun compressImage(bitmap: Bitmap, size : Int, context: Context) : ByteArray {
        ...
        if(k>1){
            // scales bitmap to fit into given size
            ...
            scaledBitmap.compress(Bitmap.CompressFormat.JPEG, 100, toReturn) // compress bitmap by JPEG
        }
        else{
    ...
    private fun loadUriIntoCircularView(imageUri : Uri, view : View, context: Context){
